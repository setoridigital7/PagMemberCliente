...
new WPUpdatesPluginUpdater_975( 'http://wp-updates.com/api/2/plugin', plugin_basename(__FILE__) );
*/

if( !class_exists('WPUpdatesPluginUpdater_975') ) {
    class WPUpdatesPluginUpdater_975 {
